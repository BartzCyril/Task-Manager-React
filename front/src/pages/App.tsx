...
function App() {
    ...
    return (
        <div style={{height: "calc(100% - 136px)"}} className={`container mx-auto mt-5 ${theme === "dark" ? "bg-gray-800" : "bg-white"} py-5`}>
                    ...
                    <div className="text-center mb-4">
                        ...
                        {!user && (
                            <p className={`text-sm ${theme === "dark" ? "text-gray-400" : "text-gray-500"}`}>
                                ...
                                Si vous n'êtes pas connecté, vos tâches seront enregistrées temporairement dans le{" "}
                                <strong>Local Storage</strong> de votre navigateur. Remarque : Le Local Storage conserve
